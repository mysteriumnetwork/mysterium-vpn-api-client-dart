...
class Subscription {
  ...
  Future<Response<void>> cancel({
    ...
    final _path = r'/subscription/cancel';
    ...
    try {
      _bodyData = jsonEncode(cancelSubscriptionRequest);
  ...
  Future<Response<InvoicesResponse>> invoices({
    ...
    return Response<InvoicesResponse>(
      data: _responseData,
  ...
  Future<Response<OrderSummaryResponse>> orderSummary({
    ...
    return Response<OrderSummaryResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<void>> pause({
    ...
    final _path = r'/subscription/pause';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
    ...
    try {
      _bodyData = jsonEncode(pauseSubscriptionRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<String>>> pauseDurations({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/subscription/pause-durations';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<List<String>, String>(rawData, 'List<String>', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetPlanResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetPlanResponse>> plan({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    return Response<GetPlanResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<void>> resume({
    ...
    final _path = r'/subscription/resume';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
  ...
  Future<Response<Subscribe200Response>> subscribe({
    ...
    return Response<Subscribe200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<SubscriptionConfigResponse>> subscriptionConfig({
    ...
    return Response<SubscriptionConfigResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<GetSubscriptionResponse>> subscriptionStatus({
    ...
    return Response<GetSubscriptionResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
