...
class EmailMarketing {
  ...
  const EmailMarketing(this._dio);
  ...
  Future<Response<ContactStatusResponse>> contactStatusRequest({
    ...
    final _path = r'/email-marketing/contact-status';
  ...
  Future<Response<void>> createContactRequest({
    ...
    final _path = r'/email-marketing/create-contact';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> setMarketingConsent({
    ...
    final _path = r'/email-marketing/marketing-consent';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      _bodyData = jsonEncode(marketingPermissionsRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> updateContactRequest({
    ...
    final _path = r'/email-marketing/update-contact';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      _bodyData = jsonEncode(updateContactRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
