...
class Connection {
  ...
  Future<Response<ProxyConnectResponse>> connectProxy({
    ...
    return Response<ProxyConnectResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ConnectionConfigResponse>> connectionConfig({
    ...
    return Response<ConnectionConfigResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ConnectionConfigRegionsResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ConnectionConfigRegionsResponse>> connectionConfigRegions({
    String? ipType,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    ConnectionConfigRegionsResponse? _responseData;
    ...
    return Response<ConnectionConfigRegionsResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<ConnectionLocation>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<ConnectionLocation>>> connectionLocations({
    String? ipType,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    List<ConnectionLocation>? _responseData;
    ...
    return Response<List<ConnectionLocation>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> disconnectAll({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> rateConnection({
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<String>>> userIntents({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
