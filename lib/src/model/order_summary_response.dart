...
class OrderSummaryResponse {
  ...
  @JsonKey(name: r'item_name', required: true, includeIfNull: false)
  ...
  @JsonKey(name: r'tax_name', required: true, includeIfNull: false)
  final String taxName;

  @JsonKey(name: r'tax_subtotal', required: true, includeIfNull: false)
  final String taxSubtotal;

  @JsonKey(name: r'order_total', required: true, includeIfNull: false)
  final String orderTotal;

  @JsonKey(name: r'coupon_error', required: false, includeIfNull: false)
