...
Token403ResponseError _$Token403ResponseErrorFromJson(Map<String, dynamic> json) =>
    $checkedCreate('Token403ResponseError', json, ($checkedConvert) {
      ...
      final val = Token403ResponseError(
        ...
        fields: $checkedConvert(
          ...
          (v) => (v as Map<String, dynamic>?)?.map(
            (k, e) =>
                MapEntry(k, Token403ResponseErrorFieldsValue.fromJson(e as Map<String, dynamic>)),
          ),
        ),
      );
      return val;
