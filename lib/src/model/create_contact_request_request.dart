...
class CreateContactRequestRequest {
  ...
  CreateContactRequestRequest({required this.status, this.customProperties, required this.country});

  @JsonKey(name: r'status', required: true, includeIfNull: false)
  final String status;

  @JsonKey(name: r'customProperties', required: false, includeIfNull: false)
