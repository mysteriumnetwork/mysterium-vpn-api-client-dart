# mysterium_vpn_api_client_dart (EXPERIMENTAL)
...
```yaml
dependencies:
  mysterium_vpn_api_client_dart: 1.0.0
```
...
dependencies:
  mysterium_vpn_api_client_dart:
    path: /path/to/mysterium_vpn_api_client_dart
```
...
## Documentation For Models
 ...
 - [RequestActivation200ResponseToken](doc/RequestActivation200ResponseToken.md)
